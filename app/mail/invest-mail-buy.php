...
if (isset($_POST['strahov-section'])) {$strahovSection = $_POST['strahov-section'];}
...
$mes = "Заявка на оформление cтраховки инвестиций\n
ФИО: $fio
Номер телефона: $phone
Почта: $mail
Город проживания: $city
Раздел страхования: $strahovSection
Перечень объектов: $list";

/* А эта функция как раз занимается отправкой письма на указанный вами email */
$sub='Заявка на оформление cтраховки инвестиций'; //сабж
