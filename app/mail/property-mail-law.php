...
if (isset($_POST['org-name'])) {$orgName = $_POST['org-name'];}
...
$mes = "Заявка на оформление cтраховки имущества\n
Название организации: $orgName
Номер телефона: $phone
Почта: $mail
Перечень объектов: $list
Расчетный счет: $card
Предварительная сумма страхования: $sum";

/* А эта функция как раз занимается отправкой письма на указанный вами email */
$sub='Заявка на оформление cтраховки имущества'; //сабж
